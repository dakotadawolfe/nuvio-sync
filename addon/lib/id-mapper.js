...
function processAndIndexData(data) {
  ...
  for (const item of animeList) {
    ...
    const tmdbIds = item.themoviedb_id && typeof item.themoviedb_id === 'object' && !Array.isArray(item.themoviedb_id)
      ? [...toIdList(item.themoviedb_id.tv), ...toIdList(item.themoviedb_id.movie)]
      : toIdList(item.themoviedb_id);
