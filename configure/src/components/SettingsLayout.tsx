...
const settingsPages = [
  { value: 'integrations', title: 'Integrations & API Keys', Component: LazyIntegrationsSettings, icon: KeyRound },
...
const DEFAULT_SETTINGS_PAGE = settingsPages[0].value;
...
export function SettingsLayout() {
  ...
  const [activeSection, setActiveSection] = useState<SettingsPageValue>(DEFAULT_SETTINGS_PAGE);
